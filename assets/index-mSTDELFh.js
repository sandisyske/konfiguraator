...
`)+`
`+p);const M=b+m+o,y=b+p+a,P=Ad(s,s.VERTEX_SHADER,M),I=Ad(s,s.FRAGMENT_SHADER,y);s.attachShader(_,P),s.attachShader(_,I),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(U){if(n.debug.checkShaderErrors){const Q=s.getProgramInfoLog(_).trim(),V=s.getShaderInfoLog(P).trim(),re=s.getShaderInfoLog(I).trim();let oe=!0,J=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(oe=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,P,I);else{const Y=Rd(s,P,"vertex"),z=Rd(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
